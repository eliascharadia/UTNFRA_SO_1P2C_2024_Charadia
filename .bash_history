...
cat $HOME/.ssh/*.pub
cd repogit/
git clone git@github.com:eliascharadia/UTNFRA_SO_1P2C_2024_Charadia.git
ll
...
git status
git add .
git commit -m "ADD: primer commit con los scripts vacios"
git config --global user.email "eliascharadia01@gmail.com"
git config --global user.name "eliascharadia"
git commit -m "ADD: primer commit con los scripts vacios"
git push
sudo mkdir /borrame
cd
...
git status
git add .
git commit -m "ADD: Realice el script del punto A"
git push
cd
rm -r Examenes-UTN/
rm -rf Examenes-UTN/
...
ls
cd repogit/UTNFRA_SO_1P2C_2024_Charadia/RTA_SCRIPT_Examen_20241009/Punto_A.sh 
cd repogit/UTNFRA_SO_1P2C_2024_Charadia/RTA_SCRIPT_Examen_20241009
vim Punto_A.sh 
cd
./repogit/UTNFRA_SO_1P2C_2024_Charadia/RTA_SCRIPT_Examen_20241009/Punto_A.sh
ls
ls -ls
ls -la
ls -l
...
sudo fdisk -l | grep "10 GiB"
sudo fdisk -l | grep "10 GiB" | awk '{print $2}'
...
tree repogit/UTNFRA_SO_1P2C_2024_Charadia
cd repogit/UTNFRA_SO_1P2C_2024_Charadia/RTA_SCRIPT_Examen_20241009/
vim Punto_A.sh 
cd
ll
